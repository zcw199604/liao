...
object ChatListTestTags {
    ...
    const val BATCH_MANAGE_BUTTON = "chatlist_batch_manage_button"
    const val BATCH_SELECT_ALL_BUTTON = "chatlist_batch_select_all_button"
    const val BATCH_EXIT_BUTTON = "chatlist_batch_exit_button"
    const val BATCH_DELETE_BUTTON = "chatlist_batch_delete_button"
    const val BATCH_DELETE_DIALOG_CONFIRM = "chatlist_batch_delete_dialog_confirm"
    const val BATCH_DELETE_DIALOG_CANCEL = "chatlist_batch_delete_dialog_cancel"

    fun item(id: String): String = "chatlist_item_$id"
    fun selectButton(id: String): String = "chatlist_item_select_$id"
