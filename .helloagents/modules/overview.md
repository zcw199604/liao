...
| 模块名称 | 职责 | 状态 | 文档 |
|---------|------|------|------|
| Auth | 认证与鉴权（访问码登录/JWT/WS 握手校验） | ✅稳定 | [链接](./auth.md) |
| Chat UI | 聊天界面交互规范（手势/弹层/WS 身份切换） | ✅稳定 | [链接](./chat-ui.md) |
| Identity | 本地身份池管理（CRUD/最近使用） | ✅稳定 | [链接](./identity.md) |
| Media | 媒体上传/媒体库/删除/重传/修复 | ✅稳定 | [链接](./media.md) |
| mtPhoto | mtPhoto 相册接入与导入上传 | ✅稳定 | [链接](./mtphoto.md) |
