...
func (a *App) buildRouter() http.Handler {
	...
	r.Route("/api", func(api chi.Router) {
		...
		api.Post("/repairVideoPosters", a.handleRepairVideoPosters)
		api.Post("/repairMediaDimensions", a.handleRepairMediaDimensions)
		...
		api.Route("/douyin", func(dr chi.Router) {
			...
			dr.Get("/favoriteUser/aweme/list", a.handleDouyinFavoriteUserAwemeList)
			dr.Post("/favoriteUser/aweme/upsert", a.handleDouyinFavoriteUserAwemeUpsert)
			dr.Post("/favoriteUser/aweme/pullLatest", a.handleDouyinFavoriteUserAwemePullLatest)
			dr.Get("/favoriteUser/tag/list", a.handleDouyinFavoriteUserTagList)
			dr.Post("/favoriteUser/tag/add", a.handleDouyinFavoriteUserTagAdd)
			...
			dr.Get("/favoriteAweme/tag/list", a.handleDouyinFavoriteAwemeTagList)
			dr.Post("/favoriteAweme/tag/add", a.handleDouyinFavoriteAwemeTagAdd)
		...
		api.Get("/getMtPhotoFolderAlbumLinks", a.handleGetMtPhotoFolderAlbumLinks)
		...
		api.Post("/batchDeleteUpstreamUsers", a.handleBatchDeleteUpstreamUsers)
